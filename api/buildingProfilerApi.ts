...
export class BuildingProfilerApi {
  ...
  /**
   * Geocode an address and match against ATTOM data to find building features for a given residence. This
   * implementation takes in an address as a required query parameter and returns geographic characteristics and
   * building features about the home if the input address is valid. Parameters ---------- address The full address
   * string for a location including street number and name, city, state, and zip code. request The raw incoming
   * request object. Returns ------- BuildingProfile An object containing geographic information like county or state
   * and building features like square footage or vintage for the residence located at the given address. Raises
   * ------ HTTPException If external APIs throw errors, the address is unparsable or missing information, or the
   * address is outside of the contiguous US.
   *
