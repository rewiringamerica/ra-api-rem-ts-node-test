...
/**
* Represents a statistic associated with a particular fuel and type of impact.  These values are taken over all the set of sample homes in the Monte Carlo simulation.
*/
